...
<head>
    ...
    <link rel="stylesheet" href="C:/xampp/htdocs/proyecto_final/assets/css/tesis.css">
    <style type="text/css">
    </style>    
</head>
<?php 
...
<body>
    ...
    <div class="card">
         ...
         <br><br>
        <div class="drop_box">
            <form action="acciones/insertar.php" class="form" method="post" enctype="multipart/form-data">
                <p>Nombre</p>
